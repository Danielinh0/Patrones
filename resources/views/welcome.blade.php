        ...
        <div class="max-w-container-max mx-auto px-lg h-full flex justify-between items-center">
            <div class="flex items-center gap-xl">
                ...
                <nav class="hidden md:flex items-center gap-lg">
                    ...
                    <a class="text-on-surface-variant font-medium hover:text-primary transition-all duration-200 font-label-caps text-label-caps" href="#">Soporte</a>
                </nav>
            </div>
            <div class="flex items-center gap-md text-primary">
                <button class="p-sm hover:bg-surface-container-high rounded-full transition-all duration-100 ease-in-out active:scale-95">
                    <span class="material-symbols-outlined">notifications</span>
                </button>
                @auth
                    <a href="{{ route('dashboard') }}" class="p-sm hover:bg-surface-container-high rounded-full transition-all duration-100 ease-in-out active:scale-95">
                        <span class="material-symbols-outlined">account_circle</span>
                    </a>
                @else
                    <a href="{{ route('login') }}" class="p-sm hover:bg-surface-container-high rounded-full transition-all duration-100 ease-in-out active:scale-95">
                        <span class="material-symbols-outlined">account_circle</span>
                    </a>
                @endauth
            </div>
