...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Estilos adicionales para Transit Flow --}}
        <style>
            body {
        ...
        {{-- Fuentes de Transit Flow --}}
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet">

        {{-- Tailwind CDN de Transit Flow --}}
    ...
    <x-layouts::app :title="__('Dashboard')">
        ...
        {{-- ===== CONTENIDO TRANSIT FLOW ===== --}}
        <div class="font-body-lg text-on-surface">
            ...
            <main class="pt-16 min-h-screen flex flex-col items-center">
                ...
                <section class="max-w-container-max w-full px-lg py-xl grid grid-cols-1 md:grid-cols-2 gap-lg">
                    <!-- Action Card 1: Emitir Nueva Tarjeta -->
                    <a class="transition-card bg-surface-container-lowest border border-outline-variant p-xl flex flex-col md:flex-row items-center gap-lg transition-all duration-300" href="#">
                ...
                <section class="w-full h-64 md:h-96 relative overflow-hidden mt-xl">
                    <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDn0L6YEhIbpFOnqKU5iBgj0cG9LqeEchyeZXSX-bwnwWwk2DtKjg1XBLwoFvI8R1VnEVM_0UGsGvjo8KxzmwNvGbZqou4Y37U0uPJlLLBGmluO39IpW3fbAkTqx9z42WAFWcfKbjpph8dwpar1BhJvJG8noOuPwsWtBHa0O2vMGD2K9tv7z3SVn0qkG5wUwZxqOYUVhLaFIyd2fV-q8K8sJhvQJqie-qjQBGlBsWKc2_dCINFXN94P9NtEQmGoqBpXT0IN8rKFTQ1m" alt="Autobús moderno en estación de tránsito">
            ...
            <footer class="w-full bg-surface-container border-t border-outline-variant">
                <div class="max-w-container-max mx-auto py-md px-lg flex flex-col md:flex-row justify-between items-center gap-md">
                    <div class="flex flex-col items-center md:items-start gap-xs">
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant text-center md:text-left">© 2024 Transit Flow. Todos los derechos reservados.</p>
                    </div>
                    <nav class="flex flex-wrap justify-center gap-lg">
                        <a class="font-label-caps text-label-caps text-on-surface-variant hover:text-primary transition-colors" href="#">Privacidad</a>
                        <a class="font-label-caps text-label-caps text-on-surface-variant hover:text-primary transition-colors" href="#">Términos</a>
                        <a class="font-label-caps text-label-caps text-on-surface-variant hover:text-primary transition-colors" href="#">Preguntas Frecuentes</a>
                        <a class="font-label-caps text-label-caps text-on-surface-variant hover:text-primary transition-colors" href="#">Contacto</a>
                    </nav>
                </div>
            </footer>

        </div>
        {{-- ===== FIN CONTENIDO TRANSIT FLOW ===== --}}
